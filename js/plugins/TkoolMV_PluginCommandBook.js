...
=============================================================================
  ...
  通常のメッセージなどで使用できるようにするか(はいいいえ)
  Default はい
  @default はい
 
  @param スクリプトに制御文字適用
  @desc スクリプト実行時に制御文字を使用できるようにするか(はいいいえ)
  Default いいえ
  @default いいえ
  ...
  バイブレーション(EnglishVibration)
   ...
   Vibration 120
  ===========================================================================
  指定位置の通行情報取得(EnglishGet_Location_Pass)
  ...
  ===========================================================================
  セルフスイッチの初期化(EnglishInit_Self_Switch)
   全てのセルフスイッチを初期化します。
   製作者 トリアコンタン
   ...
   Init_Self_Switch
  ===========================================================================
  セルフスイッチの遠隔操作(EnglishRemote_Control_Self_Switch)
  ...
  ===========================================================================
  戦闘アニメの読み込み(EnglishLoad_Animation)
  ...
  シャットダウン(EnglishShutdown)
   ...
   Shutdown
  ===========================================================================
  ウェブサイト起動(EnglishStartup_Website)
   ...
   使用例
   ウェブサイト起動 httpswww.google.co.jp
   Startup_Website httpswww.google.co.jp
  ===========================================================================
  変数の操作(EnglishControlVariable)
  ...
  パラメータ：
   ...
   引数2：操作する内容   [代入：=  加算+=  減算：-=  乗算：=  除算：=  剰余：%=]
                                                   or
                         [代入：set  加算add  減算：sub  乗算：mult  除算：div  剰余：mod]
   引数3：操作用の値
   引数4：値の型(省略可) [数字優先(省略値)：0  文字優先1]
  ...
  ===========================================================================
  タッチ座標の取得(EnglishGet_Touch_Info)
  ...
  ===========================================================================
  マップタッチ禁止の変更(EnglishChange_Map_Touch)
   ...
   Change_Map_Touch 許可
  ===========================================================================
  マップタッチ移動中判定(EnglishGet_Map_Touch_Moving)
  ...
  ===========================================================================
  マップタッチ移動(EnglishMap_Touch_Move)
  ...
  ===========================================================================
  数値入力範囲の設定(EnglishSet_Input_Num_Range)
  ...
  ===========================================================================
  数値入力ウィンドウの設定(EnglishSet_Num_Input_Window)
  ...
  ===========================================================================
  数値入力有効桁の設定(EnglishSet_Num_Input_Valid_Digit)
  ...
  ===========================================================================
  ピクチャの有効判定(EnglishGet_Picture_Valid)
  ...
  ===========================================================================
  ピクチャの表示優先度設定(EnglishSet_Picture_Priority)
  ...
  ピクチャの表示優先度設定(EnglishSet_Picture_Priority)
   ...
   Set_Picture_Priority v[1] v[2]
  ===========================================================================
  ピクチャのトリミング(EnglishTrimming_Picture)
  ...
  ===========================================================================
  ピクチャの回転角設定(EnglishAngle_Picture)
  ...
  パラメータ：
   ...
   引数2：対象の文字列
   引数3：検索する文字
   引数4：比較方法[0一致したら一致下部分から先を比較(省略値) 11文字ずつ比較]
  使用例
...
(function(){
    ...
    Game_Interpreter.prototype.pluginCommandBook_レベルの変更 = function(args) {
        ...
        var show = {表示true,非表示false,はいtrue,いいえfalse}[args[2]'表示'];
    ...
    Game_Interpreter.prototype.pluginCommandBook_文字の置換 = function(args) {
        ...
        args[4]=args[4].replace(fronti,'前方');
        args[4]=args[4].replace(backi,'後方');
        args[4]=args[4].replace(alli,'全て');
        switch (args[4]){
          case '前方'
    ...
    Game_Interpreter.prototype.pluginCommandBook_文字の検索 = function(args) {
        ...
        args[3]=args[3].replace(fronti,'前方');
        args[3]=args[3].replace(backi,'後方');
        switch (args[3]){
          case '前方'
          default
